...
Mirjalol. In this video we will get into making our own custom functions.
...
![running the script named cf in console printing it works](/running-script-in-console.png)
...
![run calculateBill bill function in console by typing calculateBill and pressing enter](/running-calculate-bill-function-in-console.png)
...
![calculateBill function returned undefined as we did not returned anything from it](/calculate-bill-function-returning-undefined-in-console.png)
...
![calculateBill function calculate the total by multiplying 100 and 1.13 and prints in console](/calculate-bill-function-logging-bill-in-console.png)
...
![printing total variable outside calculateBill function throws not defined error](/total-not-defined-error-in-console.png)
...
![returning total variable from calculateBill function prints the returned value ](/printing-returned-value-from-function-in-console.png)
